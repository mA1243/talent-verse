        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-talent-purple transition-colors">FAQ</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-talent-purple transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
